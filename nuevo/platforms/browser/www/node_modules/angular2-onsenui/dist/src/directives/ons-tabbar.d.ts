import { ViewContainerRef, ComponentFactoryResolver, ElementRef, Type, OnDestroy } from '@angular/core';
/**
 * @element ons-tab
 * @directive OnsTab
 * @selector ons-tab
...
export declare class OnsTab implements OnDestroy {
     ...
     */
    page: Type<any>;
    constructor(_elementRef: ElementRef, _viewContainer: ViewContainerRef, _resolver: ComponentFactoryResolver);
    ngOnDestroy(): void;
}
