/*! angular2-onsenui v1.0.0-rc.4 - Fri Jan 13 2017 19:28:15 GMT+0900 (JST) */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OnsNavigator = (function () {
	    ...
	    OnsNavigator = __decorate([
	        ...
	        __metadata('design:paramtypes', [core_1.ElementRef, core_1.ComponentFactoryResolver, core_1.ViewContainerRef, core_1.Injector])
	    ], OnsNavigator);
	    return OnsNavigator;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OnsTab = (function () {
	    ...
	    OnsTab = __decorate([
	        ...
	        __metadata('design:paramtypes', [core_1.ElementRef, core_1.ViewContainerRef, core_1.ComponentFactoryResolver])
	    ], OnsTab);
	    return OnsTab;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AlertDialogFactory = (function () {
	    ...
	    AlertDialogFactory = __decorate([
	        core_1.Injectable(), 
	        __metadata('design:paramtypes', [core_1.Injector, core_1.ComponentFactoryResolver, core_1.ApplicationRef, component_loader_1.ComponentLoader])
	    ], AlertDialogFactory);
