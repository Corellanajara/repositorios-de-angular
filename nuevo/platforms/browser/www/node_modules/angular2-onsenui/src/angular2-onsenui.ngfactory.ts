...
import * as import1 from './angular2-onsenui';
...
import * as import18 from './ons/component-loader';
import * as import19 from './ons/alert-dialog-factory';
import * as import20 from './ons/popover-factory';
import * as import21 from './ons/dialog-factory';
import * as import22 from './ons/modal-factory';
...
class OnsenModuleInjector extends import0.NgModuleInjector<import1.OnsenModule> {
  _CommonModule_0:import2.CommonModule;
  _ApplicationModule_1:import3.ApplicationModule;
  _BrowserModule_2:import4.BrowserModule;
  _OnsenModule_3:import1.OnsenModule;
  __LOCALE_ID_4:any;
  ...
  __ComponentLoader_29:import18.ComponentLoader;
  __AlertDialogFactory_30:import19.AlertDialogFactory;
  __PopoverFactory_31:import20.PopoverFactory;
  __DialogFactory_32:import21.DialogFactory;
  __ModalFactory_33:import22.ModalFactory;
  ...
  get _ComponentLoader_29():import18.ComponentLoader {
    if ((this.__ComponentLoader_29 == null)) { (this.__ComponentLoader_29 = new import18.ComponentLoader(this._ApplicationRef_10)); }
    return this.__ComponentLoader_29;
  }
  get _AlertDialogFactory_30():import19.AlertDialogFactory {
    if ((this.__AlertDialogFactory_30 == null)) { (this.__AlertDialogFactory_30 = new import19.AlertDialogFactory(this,this,this._ApplicationRef_10,this._ComponentLoader_29)); }
    return this.__AlertDialogFactory_30;
  }
  get _PopoverFactory_31():import20.PopoverFactory {
    if ((this.__PopoverFactory_31 == null)) { (this.__PopoverFactory_31 = new import20.PopoverFactory(this,this,this._ApplicationRef_10,this._ComponentLoader_29)); }
    return this.__PopoverFactory_31;
  }
  get _DialogFactory_32():import21.DialogFactory {
    if ((this.__DialogFactory_32 == null)) { (this.__DialogFactory_32 = new import21.DialogFactory(this,this,this._ApplicationRef_10,this._ComponentLoader_29)); }
    return this.__DialogFactory_32;
  }
  get _ModalFactory_33():import22.ModalFactory {
    if ((this.__ModalFactory_33 == null)) { (this.__ModalFactory_33 = new import22.ModalFactory(this,this,this._ApplicationRef_10,this._ComponentLoader_29)); }
    return this.__ModalFactory_33;
  }
  createInternal():import1.OnsenModule {
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import1.OnsenModule)) { return this._OnsenModule_3; }
    if ((token === import30.LOCALE_ID)) { return this._LOCALE_ID_4; }
    if ((token === import5.NgLocalization)) { return this._NgLocalization_5; }
    if ((token === import31.ErrorHandler)) { return this._ErrorHandler_6; }
    ...
    if ((token === import32.DOCUMENT)) { return this._DOCUMENT_13; }
    ...
    if ((token === import33.AnimationDriver)) { return this._AnimationDriver_18; }
    if ((token === import13.DomRootRenderer)) { return this._DomRootRenderer_19; }
    if ((token === import34.RootRenderer)) { return this._RootRenderer_20; }
    if ((token === import14.DomSanitizer)) { return this._DomSanitizer_21; }
    if ((token === import35.Sanitizer)) { return this._Sanitizer_22; }
    ...
    if ((token === import18.ComponentLoader)) { return this._ComponentLoader_29; }
    if ((token === import19.AlertDialogFactory)) { return this._AlertDialogFactory_30; }
    if ((token === import20.PopoverFactory)) { return this._PopoverFactory_31; }
    if ((token === import21.DialogFactory)) { return this._DialogFactory_32; }
    if ((token === import22.ModalFactory)) { return this._ModalFactory_33; }
...
export const OnsenModuleNgFactory:import0.NgModuleFactory<import1.OnsenModule> = new import0.NgModuleFactory(OnsenModuleInjector,import1.OnsenModule);