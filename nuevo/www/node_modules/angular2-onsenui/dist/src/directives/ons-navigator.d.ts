import { Injector, ElementRef, Type, ComponentFactoryResolver, ViewContainerRef, OnDestroy } from '@angular/core';
...
export declare class OnsNavigator implements OnDestroy {
    ...
    constructor(_elementRef: ElementRef, _resolver: ComponentFactoryResolver, _viewContainer: ViewContainerRef, _injector: Injector);
